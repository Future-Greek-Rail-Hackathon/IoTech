...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Thing">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($sensor_types as $key => $item)
...
{ data: 'name', name: 'name' },
{ data: 'eui', name: 'eui' },
{ data: 'installed_at', name: 'installed_at' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Thing').DataTable(dtOverrideGlobals);
